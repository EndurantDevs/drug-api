"""Canonical label model usable by application and archive runtimes."""
...
class LabelMetadataBase(DeclarativeBase):
    """Independent metadata; importing the model does not initialize an application."""


class Label(LabelMetadataBase):
    __tablename__ = "label"
    __table_args__ = ({"schema": os.getenv("DB_SCHEMA") or "rx_data", "extend_existing": True},)
    abuse = Column(String)
    ...
    __my_additional_indexes__ = (
        {"name": "product_ndc", "index_elements": ["product_ndc"], "using": "gin"},
        {"name": "package_ndc", "index_elements": ["package_ndc"], "using": "gin"},
        {"name": "label_id", "index_elements": ["id"]},
        {"name": "label_set_id", "index_elements": ["set_id"]},
    )
