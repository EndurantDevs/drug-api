...
async def get_generic_packages(product_name):
    ...
    q = db.select(
        ...
        Product.__table__.join(Package.__table__, Product.product_ndc == Package.product_ndc)).where(
...
async def get_generic_products(product_name):
    ...
    q = db.select(
        [Product.generic_name, Product.brand_name, Product.dosage_form, Product.product_ndc,
            Product.labeler_name]).where(Product.product_ndc.in_(subq.statement)).order_by(Product.product_ndc.desc())
...
async def get_brand_products(product_name):
    ...
    q = db.select(
        [Product.generic_name, Product.brand_name, Product.dosage_form, Product.product_ndc,
            Product.labeler_name]).where(Product.product_ndc.in_(subq.statement)).order_by(Product.brand_name.desc())
